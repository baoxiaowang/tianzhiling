...
- Irreversible actions fail closed: without confirmed proof, refuse to execute (e.g. never revoke membership/benefits when WeChat has not confirmed refund success); releases and production data changes need independent sign-off.
