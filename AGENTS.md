...
- Do not invoke Royal TSX's paid AppleScript or licensed automation interface. After explicit user authorization, free/shareware UI interaction may operate an already-open Royal terminal or select the saved TianZhiLing connection, provided it does not call the paid Royal automation service.
