...
const INDEXES = {
  conversation_reply_turn: [
    ...
    [
      { activeKey: 1 },
      {
        name: 'uniq_conversation_reply_turn_active',
        unique: true,
        sparse: true,
      },
    ],
    [
      { status: 1, collectNotBeforeAt: 1 },
      { name: 'idx_conversation_reply_turn_due' },
    ],
    [
      { conversationId: 1, createdAt: -1 },
      { name: 'idx_conversation_reply_turn_history' },
    ],
  ],
  message: [
    [
      { replyTurnId: 1, createdAt: 1 },
      { name: 'idx_message_reply_turn', sparse: true },
    ],
  ],
};
