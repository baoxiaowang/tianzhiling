...
// P1-5: 时间/星期/常见地点词黑名单——避免"我改成明天吧"被记成用户叫"明天"
const NON_NAME_TIME_PLACE_EXACT = new Set([
  // 时间
  '今天', '明天', '后天', '昨天', '前天', '大前天', '大后天',
  '早上', '上午', '中午', '下午', '晚上', '傍晚', '凌晨', '深夜',
  '周一', '周二', '周三', '周四', '周五', '周六', '周日', '星期天',
  ...
  '七月', '八月', '九月', '十月', '十一月', '十二月',
  // 常见地点
  '家里', '家', '公司', '学校', '单位', '办公室', '工厂', '店里',
  '北京', '上海', '广州', '深圳', '武汉', '成都', '重庆', '杭州', '南京',
  '西安', '苏州', '天津', '长沙', '郑州', '青岛', '大连', '厦门', '宁波',
  '中国', '美国', '日本', '韩国', '英国', '法国', '德国',
  '超市', '商场', '医院', '公园', '机场', '车站', '火车站', '高铁站',
  '食堂', '餐厅', '饭店', '酒店', '旅馆', '宾馆',
  '厕所', '卫生间', '洗手间', '厨房', '卧室', '客厅', '阳台', '花园',
  '楼上', '楼下', '门口', '路边', '街上', '路上',
]);
...
function normalizeName(value?: string): string | undefined {
  ...
  if (
    ...
    NON_NAME_TIME_PLACE_EXACT.has(name) ||
