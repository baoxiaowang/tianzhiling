...
const USER_CARE_TOWARD_ROLE_PATTERN =
  /(?:吃(?:过)?饭(?:了)?(?:吗|没|没有)|吃(?:了|过)(?:吗|没|没有)|吃没吃|喝水(?:了)?吗|睡(?:得)?(?:好|着)?吗|休息(?:了|好)?吗|过得(?:怎么样|好不好|好吗|好么|好不)|你好吗|还好吗|好不好|没事吧|冷不冷|热不热|疼不疼|累不累|身体怎么样)|(?:我|我们|大家|爸|爸爸|妈|妈妈|爷爷|奶奶|姥姥|姥爷|外公|外婆|孩子|姐姐|哥哥).{0,8}(?:关心|担心|挂心|挂念|牵挂|惦记|心疼|放心不下|怕)(?:你|您)|(?:想着|怕|担心|惦记|挂念|牵挂).{0,8}(?:你|您).{0,12}(?:吃不上|没吃|挨饿|受冷|冷|热|累|辛苦|不好)|(?:你|您)(?:(?!心疼).){0,12}(?:(?:还)?(?:疼|冷|热|累)(?:吗|不|没|好些|好点)|辛苦了|太辛苦|累坏了)|(?:记得|要|得|可要|别|不要).{0,12}(?:添衣|穿暖|吃饭|喝水|休息|睡觉|熬夜|太累|太辛苦|照顾好(?:你|您)?自己|保重)|(?:别|不要)(?:再)?(?:不?舍得).{0,6}(?:花|买|吃)|(?:乐意|想)吃啥(?:就)?(?:买啥|吃啥)|(?:你|您)(?:也|要|可要|一定要|得).{0,8}(?:照顾好(?:你|您)?自己|保重|好好的)|^(?:保重|你要好好的|您要好好的)[。！!…\s]*$/;
const ACTIVE_SPEECH_REQUEST_PATTERN =
  /(?:你|您)(?:也|来|再|多)?(?:主动)?(?:说|讲|聊)(?:点|些|说)?(?:(?:什么|几句)|(?:自己|你自己的|你的)(?:事|话|情况|想法)?)|(?:也|再|多)?说说自己|也说点(?:你|自己的)(?:事|话)?|别(?:老|总|光)?问我.{0,12}(?:你|您)?(?:主动)?说/;
