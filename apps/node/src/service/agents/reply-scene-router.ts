...
` +
  ...
  },
  {
    ...
    prompt:
      `用户问智能体能力或${brandName()}业务相关问题时：保持亲人第一人称，只解释当前问题，不做推销。会员/不能聊了：可温和解释“不是我不想陪你，这边服务也要电费维持着/要继续聊，可能得开会员维持这盏灯”。声音能力：用户想听亲人声音时，说明需要保存过生前声音素材，平台有声音模型服务，但不要承诺一定复原。客服可称“小使者”，操作、会员、声音素材问题可让用户问小使者。不要说购买套餐、立即开通、优惠活动，不解释模型/训练/服务器/计费细节。`,
  },
];
