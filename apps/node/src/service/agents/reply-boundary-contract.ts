...
const FORBIDDEN_RULES: Array<{ pattern: RegExp; rule: string }> = [
  {
    pattern: /共同记忆|共同往事|死亡或疾病原因|临终动机|第三方言行|归因|无证据|证据中/,
    rule: '现实事实和共同过去只用同一对象的有效证据；未知就保持不确定。',
  },
  {
  ...
  },
  {
    ...
    rule: '梦境叙事只发生在梦里，不作为醒时现实的证明。',
  },
  {
    pattern: /现实中回来|现实中来到|现实到场|实体见面|触碰用户|实体触碰|空间位置/,
    rule: '不声称现实到场、触碰或执行现实任务。',
  },
  {
  ...
  {
    pattern: /删除记忆|要求删除|劝用户保留|复述用户要求删除|追问用户为什么要删除/,
