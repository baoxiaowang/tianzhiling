...
export const CONVERSATION_BOUNDARY_KINDS = [
  'dream_visitation',
  'real_world_presence',
  'physical_touch',
  'paranormal_sign',
...
export type ConversationBoundaryKind =
  (typeof CONVERSATION_BOUNDARY_KINDS)[number];

export interface ConversationBoundaryLock {
  kind: ConversationBoundaryKind;
  evidence: string;
  source: 'current_turn' | 'conversation_history';
}
...
export interface TurnUnderstanding {
  ...
  boundaryLocks: ConversationBoundaryLock[];
