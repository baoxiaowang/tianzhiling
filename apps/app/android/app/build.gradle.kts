...
android {
    ...
    buildTypes {
        release {
            // Use the release keystore when present, otherwise keep debug signing
            // so local release builds still work before credentials are added.
            signingConfig =
                if (hasReleaseSigning) {
